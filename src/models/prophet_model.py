...
def train_prophet(processed_file="data/preprocessed_dataset.csv", 
    ...
    # ----------------------------
    periods_5min = 24*12  # 24 hours × 12 = 288 steps (5-min)
    future_5min = model.make_future_dataframe(periods=periods_5min, freq='5T')
    ...
    # ----------------------------
    # Return model, forecasts, and JSON paths
    # ----------------------------
